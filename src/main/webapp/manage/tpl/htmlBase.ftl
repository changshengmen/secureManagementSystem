...
<head>
    ...
    <title>${(title?? && title!="")?string("${systemSetting().systemCode} - "+ title , "金鼎涛销售MIS系统")}</title>
    ...
    <script type="text/javascript" src="${staticpath}/js/jquery.easydropdown.min.js"></script>
