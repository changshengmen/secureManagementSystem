        ...
        <div class="col-md-4 col-md-offset-4">
            <div class="login-panel panel panel-success">
                <div class="panel-heading">
                    <h3 class="panel-title"><b>${systemSetting().name}</b></h3>
                </div>
                        ...
                        <fieldset>
                            ...
                            <div class="row help-block">
                                <div class="col-md-offset-1 col-md-11">
                                   ...
                                   <!-- <a class="btn btn-link" href="http://git.oschina.net/dinguangx/jshop" target="_blank"><span class="fa fa-git-square">源码</a>-->
                                </div>
                            </div>
                        <#--<div class="checkbox">-->
                        <#--<label>-->
...
<#--<tr>-->
<#--<td colspan="2" style="text-align: center;">测试账号2：test1/123456-->
<#--</td>-->
<#--</tr>-->
<#--<tr>-->
